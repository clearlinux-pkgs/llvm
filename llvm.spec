...
Source0  : https://github.com/llvm/llvm-project/releases/download/llvmorg-19.1.3/llvm-project-19.1.3.src.tar.xz
...
Source3  : https://github.com/llvm/llvm-project/releases/download/llvmorg-19.1.3/llvm-project-19.1.3.src.tar.xz.sig
...
%setup -q -n llvm-project-19.1.3.src
cd %{_builddir}
tar xf %{_sourcedir}/v19.1.0.tar.gz
cd %{_builddir}
tar xf %{_sourcedir}/vulkan-sdk-1.3.290.0.tar.gz
cd %{_builddir}/llvm-project-19.1.3.src
mkdir -p llvm/projects/SPIRV-LLVM-Translator
cp -r %{_builddir}/SPIRV-LLVM-Translator-19.1.0/* %{_builddir}/llvm-project-19.1.3.src/llvm/projects/SPIRV-LLVM-Translator
mkdir -p llvm/projects/SPIRV-Headers
cp -r %{_builddir}/SPIRV-Headers-vulkan-sdk-1.3.290.0/* %{_builddir}/llvm-project-19.1.3.src/llvm/projects/SPIRV-Headers
%patch -P 1 -p1
%patch -P 2 -p1
%patch -P 3 -p1
%patch -P 4 -p1
...
%patch -P 7 -p1
pushd ..
cp -a llvm-project-19.1.3.src build32
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1731097777
unset LD_AS_NEEDED
pushd llvm
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libclang.so.19.1.3
/usr/lib64/liblldb.so
/usr/lib64/liblldb.so.19.1
/usr/lib64/liblldb.so.19.1.3
