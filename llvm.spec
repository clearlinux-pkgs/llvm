...
Source2  : https://github.com/llvm/llvm-project/releases/download/llvmorg-10.0.0/clang-10.0.0.src.tar.xz
Source3  : https://github.com/llvm/llvm-project/releases/download/llvmorg-10.0.0/clang-tools-extra-10.0.0.src.tar.xz
Source4  : https://github.com/llvm/llvm-project/releases/download/llvmorg-10.0.0/compiler-rt-10.0.0.src.tar.xz
Source5  : https://github.com/llvm/llvm-project/releases/download/llvmorg-10.0.0/lld-10.0.0.src.tar.xz
Source6  : https://github.com/llvm/llvm-project/releases/download/llvmorg-10.0.0/openmp-10.0.0.src.tar.xz
Source7  : https://github.com/llvm/llvm-project/releases/download/llvmorg-10.0.0/llvm-10.0.0.src.tar.xz.sig
...
Patch11: openmp-0001-Disable-broken-amdgcn-target.patch
...
%package extras-libclangtidydarwinmodule
Summary: extras-libclangtidydarwinmodule components for the llvm package.
Group: Default

%description extras-libclangtidydarwinmodule
extras-libclangtidydarwinmodule components for the llvm package.
...
%package extras-libclangtidylinuxkernelmodule
Summary: extras-libclangtidylinuxkernelmodule components for the llvm package.
Group: Default

%description extras-libclangtidylinuxkernelmodule
extras-libclangtidylinuxkernelmodule components for the llvm package.
...
%package extras-libclangtransformer
Summary: extras-libclangtransformer components for the llvm package.
Group: Default

%description extras-libclangtransformer
extras-libclangtransformer components for the llvm package.
...
%prep
%setup -q -n llvm-10.0.0.src
cd %{_builddir}
tar xf %{_sourcedir}/clang-10.0.0.src.tar.xz
cd %{_builddir}
tar xf %{_sourcedir}/clang-tools-extra-10.0.0.src.tar.xz
cd %{_builddir}
tar xf %{_sourcedir}/lld-10.0.0.src.tar.xz
cd %{_builddir}
tar xf %{_sourcedir}/openmp-10.0.0.src.tar.xz
cd %{_builddir}
tar xf %{_sourcedir}/compiler-rt-10.0.0.src.tar.xz
cd %{_builddir}
tar xf %{_sourcedir}/SPIRV-10.0.0.tar.gz
cd %{_builddir}/llvm-10.0.0.src
mkdir -p tools/clang
cp -r %{_builddir}/clang-10.0.0.src/* %{_builddir}/llvm-10.0.0.src/tools/clang
mkdir -p tools/clang/tools/extra
cp -r %{_builddir}/clang-tools-extra-10.0.0.src/* %{_builddir}/llvm-10.0.0.src/tools/clang/tools/extra
mkdir -p tools/lld
cp -r %{_builddir}/lld-10.0.0.src/* %{_builddir}/llvm-10.0.0.src/tools/lld
mkdir -p projects/openmp
cp -r %{_builddir}/openmp-10.0.0.src/* %{_builddir}/llvm-10.0.0.src/projects/openmp
mkdir -p projects/compiler-rt
cp -r %{_builddir}/compiler-rt-10.0.0.src/* %{_builddir}/llvm-10.0.0.src/projects/compiler-rt
mkdir -p projects/SPIRV
cp -r %{_builddir}/SPIRV-LLVM-Translator-10.0.0/* %{_builddir}/llvm-10.0.0.src/projects/SPIRV
%patch1 -p1
%patch2 -p1
%patch3 -p1
%patch4 -p1
...
cp %{_builddir}/clang-10.0.0.src/LICENSE.TXT %{buildroot}/usr/share/package-licenses/llvm/a1691103171dc1d21cfa85f1d4809a16b9f1367f
cp %{_builddir}/clang-10.0.0.src/tools/clang-format-vs/ClangFormat/license.txt %{buildroot}/usr/share/package-licenses/llvm/b5d4ab4d1191e592c03310adfbe90d99a46bf9d7
cp %{_builddir}/clang-tools-extra-10.0.0.src/LICENSE.TXT %{buildroot}/usr/share/package-licenses/llvm/a1691103171dc1d21cfa85f1d4809a16b9f1367f
cp %{_builddir}/clang-tools-extra-10.0.0.src/clangd/clients/clangd-vscode/LICENSE %{buildroot}/usr/share/package-licenses/llvm/27311ab9774bb8ce4b1c6d1f5c8c4d45689792a4
cp %{_builddir}/compiler-rt-10.0.0.src/LICENSE.TXT %{buildroot}/usr/share/package-licenses/llvm/f4359b9da55a3b9e4d9513eb79cacf125fb49e7b
cp %{_builddir}/lld-10.0.0.src/LICENSE.TXT %{buildroot}/usr/share/package-licenses/llvm/6b655b0685aa7ee33fa1e02103b3bf22ed06e099
cp %{_builddir}/llvm-10.0.0.src/LICENSE.TXT %{buildroot}/usr/share/package-licenses/llvm/af07f365643f841c69797e9059b66f0bd847f1cd
cp %{_builddir}/llvm-10.0.0.src/test/YAMLParser/LICENSE.txt %{buildroot}/usr/share/package-licenses/llvm/c01c212bdf3925189f673e2081b44094023860ea
cp %{_builddir}/llvm-10.0.0.src/tools/msbuild/license.txt %{buildroot}/usr/share/package-licenses/llvm/b5d4ab4d1191e592c03310adfbe90d99a46bf9d7
cp %{_builddir}/llvm-10.0.0.src/utils/benchmark/LICENSE %{buildroot}/usr/share/package-licenses/llvm/2b8b815229aa8a61e483fb4ba0588b8b6c491890
cp %{_builddir}/llvm-10.0.0.src/utils/unittest/googlemock/LICENSE.txt %{buildroot}/usr/share/package-licenses/llvm/5a2314153eadadc69258a9429104cd11804ea304
cp %{_builddir}/llvm-10.0.0.src/utils/unittest/googletest/LICENSE.TXT %{buildroot}/usr/share/package-licenses/llvm/5a2314153eadadc69258a9429104cd11804ea304
cp %{_builddir}/openmp-10.0.0.src/LICENSE.txt %{buildroot}/usr/share/package-licenses/llvm/e3cccabb67bd491a643d32a7d2b65b49836e626d
pushd clr-build32
%make_install32
...
/usr/lib64/clang/10.0.0/lib/linux/clang_rt.crtbegin-i386.o
/usr/lib64/clang/10.0.0/lib/linux/clang_rt.crtbegin-x86_64.o
/usr/lib64/clang/10.0.0/lib/linux/clang_rt.crtend-i386.o
/usr/lib64/clang/10.0.0/lib/linux/clang_rt.crtend-x86_64.o
/usr/lib64/clang/10.0.0/lib/linux/libclang_rt.asan-i386.a
/usr/lib64/clang/10.0.0/lib/linux/libclang_rt.asan-preinit-i386.a
...
/usr/lib64/clang/10.0.0/lib/linux/libclang_rt.asan_cxx-i386.a
...
/usr/lib64/clang/10.0.0/lib/linux/libclang_rt.builtins-i386.a
/usr/lib64/clang/10.0.0/lib/linux/libclang_rt.builtins-x86_64.a
/usr/lib64/clang/10.0.0/lib/linux/libclang_rt.cfi-i386.a
/usr/lib64/clang/10.0.0/lib/linux/libclang_rt.cfi-x86_64.a
/usr/lib64/clang/10.0.0/lib/linux/libclang_rt.cfi_diag-i386.a
...
/usr/lib64/clang/10.0.0/lib/linux/libclang_rt.fuzzer-i386.a
/usr/lib64/clang/10.0.0/lib/linux/libclang_rt.fuzzer-x86_64.a
/usr/lib64/clang/10.0.0/lib/linux/libclang_rt.fuzzer_no_main-i386.a
/usr/lib64/clang/10.0.0/lib/linux/libclang_rt.fuzzer_no_main-x86_64.a
/usr/lib64/clang/10.0.0/lib/linux/libclang_rt.gwp_asan-i386.a
...
/usr/lib64/clang/10.0.0/lib/linux/libclang_rt.lsan-i386.a
...
/usr/lib64/clang/10.0.0/lib/linux/libclang_rt.profile-i386.a
/usr/lib64/clang/10.0.0/lib/linux/libclang_rt.profile-x86_64.a
/usr/lib64/clang/10.0.0/lib/linux/libclang_rt.safestack-i386.a
/usr/lib64/clang/10.0.0/lib/linux/libclang_rt.safestack-x86_64.a
/usr/lib64/clang/10.0.0/lib/linux/libclang_rt.scudo-i386.a
/usr/lib64/clang/10.0.0/lib/linux/libclang_rt.scudo-x86_64.a
/usr/lib64/clang/10.0.0/lib/linux/libclang_rt.scudo_cxx-i386.a
/usr/lib64/clang/10.0.0/lib/linux/libclang_rt.scudo_cxx-x86_64.a
/usr/lib64/clang/10.0.0/lib/linux/libclang_rt.scudo_cxx_minimal-i386.a
/usr/lib64/clang/10.0.0/lib/linux/libclang_rt.scudo_cxx_minimal-x86_64.a
/usr/lib64/clang/10.0.0/lib/linux/libclang_rt.scudo_minimal-i386.a
/usr/lib64/clang/10.0.0/lib/linux/libclang_rt.scudo_minimal-x86_64.a
/usr/lib64/clang/10.0.0/lib/linux/libclang_rt.scudo_standalone-i386.a
/usr/lib64/clang/10.0.0/lib/linux/libclang_rt.scudo_standalone-x86_64.a
/usr/lib64/clang/10.0.0/lib/linux/libclang_rt.scudo_standalone_cxx-i386.a
/usr/lib64/clang/10.0.0/lib/linux/libclang_rt.scudo_standalone_cxx-x86_64.a
/usr/lib64/clang/10.0.0/lib/linux/libclang_rt.stats-i386.a
/usr/lib64/clang/10.0.0/lib/linux/libclang_rt.stats-x86_64.a
/usr/lib64/clang/10.0.0/lib/linux/libclang_rt.stats_client-i386.a
...
/usr/lib64/clang/10.0.0/lib/linux/libclang_rt.ubsan_minimal-i386.a
...
/usr/lib64/clang/10.0.0/lib/linux/libclang_rt.ubsan_standalone-i386.a
...
/usr/lib64/clang/10.0.0/lib/linux/libclang_rt.ubsan_standalone_cxx-i386.a
...
/usr/bin/clang-apply-replacements-10
/usr/bin/clang-change-namespace
/usr/bin/clang-change-namespace-10
/usr/bin/clang-check
...
/usr/bin/clang-include-fixer-10
/usr/bin/clang-move
/usr/bin/clang-move-10
...
/usr/bin/sanstats-10
/usr/bin/scan-build
/usr/bin/scan-build-10
/usr/bin/scan-view
/usr/bin/scan-view-10
...
/usr/lib64/libclangTidyDarwinModule.so
...
/usr/lib64/libclangTidyLinuxKernelModule.so
...
/usr/lib64/libclangTransformer.so
...
/usr/lib64/clang/10.0.0/include/omp-tools.h
/usr/lib64/clang/10.0.0/include/omp.h
/usr/lib64/clang/10.0.0/include/ompt.h
...
%defattr(-,root,root,-)
/usr/lib64/libclangAnalysis.so.10

%files extras-libclangapplyreplacements
%defattr(-,root,root,-)
/usr/lib64/libclangApplyReplacements.so.10

%files extras-libclangarcmigrate
%defattr(-,root,root,-)
/usr/lib64/libclangARCMigrate.so.10

%files extras-libclangast
%defattr(-,root,root,-)
/usr/lib64/libclangAST.so.10

%files extras-libclangastmatchers
%defattr(-,root,root,-)
/usr/lib64/libclangASTMatchers.so.10

%files extras-libclangbasic
%defattr(-,root,root,-)
/usr/lib64/libclangBasic.so.10

%files extras-libclangchangenamespace
%defattr(-,root,root,-)
/usr/lib64/libclangChangeNamespace.so.10

%files extras-libclangcodegen
%defattr(-,root,root,-)
/usr/lib64/libclangCodeGen.so.10

%files extras-libclangcrosstu
%defattr(-,root,root,-)
/usr/lib64/libclangCrossTU.so.10

%files extras-libclangdaemon
%defattr(-,root,root,-)
/usr/lib64/libclangDaemon.so.10

%files extras-libclangdaemontweaks
%defattr(-,root,root,-)
/usr/lib64/libclangDaemonTweaks.so.10

%files extras-libclangdependencyscanning
%defattr(-,root,root,-)
/usr/lib64/libclangDependencyScanning.so.10

%files extras-libclangdirectorywatcher
%defattr(-,root,root,-)
/usr/lib64/libclangDirectoryWatcher.so.10

%files extras-libclangdoc
%defattr(-,root,root,-)
/usr/lib64/libclangDoc.so.10

%files extras-libclangdriver
%defattr(-,root,root,-)
/usr/lib64/libclangDriver.so.10

%files extras-libclangdynamicastmatchers
%defattr(-,root,root,-)
/usr/lib64/libclangDynamicASTMatchers.so.10

%files extras-libclangedit
%defattr(-,root,root,-)
/usr/lib64/libclangEdit.so.10

%files extras-libclangformat
%defattr(-,root,root,-)
/usr/lib64/libclangFormat.so.10

%files extras-libclangfrontend
%defattr(-,root,root,-)
/usr/lib64/libclangFrontend.so.10

%files extras-libclangfrontendtool
%defattr(-,root,root,-)
/usr/lib64/libclangFrontendTool.so.10

%files extras-libclanghandlecxx
%defattr(-,root,root,-)
/usr/lib64/libclangHandleCXX.so.10

%files extras-libclanghandlellvm
%defattr(-,root,root,-)
/usr/lib64/libclangHandleLLVM.so.10

%files extras-libclangincludefixer
%defattr(-,root,root,-)
/usr/lib64/libclangIncludeFixer.so.10

%files extras-libclangincludefixerplugin
%defattr(-,root,root,-)
/usr/lib64/libclangIncludeFixerPlugin.so.10

%files extras-libclangindex
%defattr(-,root,root,-)
/usr/lib64/libclangIndex.so.10

%files extras-libclanglex
%defattr(-,root,root,-)
/usr/lib64/libclangLex.so.10

%files extras-libclangmove
%defattr(-,root,root,-)
/usr/lib64/libclangMove.so.10

%files extras-libclangparse
%defattr(-,root,root,-)
/usr/lib64/libclangParse.so.10

%files extras-libclangquery
%defattr(-,root,root,-)
/usr/lib64/libclangQuery.so.10

%files extras-libclangreorderfields
%defattr(-,root,root,-)
/usr/lib64/libclangReorderFields.so.10

%files extras-libclangrewrite
%defattr(-,root,root,-)
/usr/lib64/libclangRewrite.so.10

%files extras-libclangrewritefrontend
%defattr(-,root,root,-)
/usr/lib64/libclangRewriteFrontend.so.10

%files extras-libclangsema
%defattr(-,root,root,-)
/usr/lib64/libclangSema.so.10

%files extras-libclangserialization
%defattr(-,root,root,-)
/usr/lib64/libclangSerialization.so.10

%files extras-libclangstaticanalyzercheckers
%defattr(-,root,root,-)
/usr/lib64/libclangStaticAnalyzerCheckers.so.10

%files extras-libclangstaticanalyzercore
%defattr(-,root,root,-)
/usr/lib64/libclangStaticAnalyzerCore.so.10

%files extras-libclangstaticanalyzerfrontend
%defattr(-,root,root,-)
/usr/lib64/libclangStaticAnalyzerFrontend.so.10

%files extras-libclangtidy
%defattr(-,root,root,-)
/usr/lib64/libclangTidy.so.10

%files extras-libclangtidyabseilmodule
%defattr(-,root,root,-)
/usr/lib64/libclangTidyAbseilModule.so.10

%files extras-libclangtidyandroidmodule
%defattr(-,root,root,-)
/usr/lib64/libclangTidyAndroidModule.so.10

%files extras-libclangtidyboostmodule
%defattr(-,root,root,-)
/usr/lib64/libclangTidyBoostModule.so.10

%files extras-libclangtidybugpronemodule
%defattr(-,root,root,-)
/usr/lib64/libclangTidyBugproneModule.so.10

%files extras-libclangtidycertmodule
%defattr(-,root,root,-)
/usr/lib64/libclangTidyCERTModule.so.10

%files extras-libclangtidycppcoreguidelinesmodule
%defattr(-,root,root,-)
/usr/lib64/libclangTidyCppCoreGuidelinesModule.so.10

%files extras-libclangtidydarwinmodule
%defattr(-,root,root,-)
/usr/lib64/libclangTidyDarwinModule.so.10

%files extras-libclangtidyfuchsiamodule
%defattr(-,root,root,-)
/usr/lib64/libclangTidyFuchsiaModule.so.10

%files extras-libclangtidygooglemodule
%defattr(-,root,root,-)
/usr/lib64/libclangTidyGoogleModule.so.10

%files extras-libclangtidyhicppmodule
%defattr(-,root,root,-)
/usr/lib64/libclangTidyHICPPModule.so.10

%files extras-libclangtidylinuxkernelmodule
%defattr(-,root,root,-)
/usr/lib64/libclangTidyLinuxKernelModule.so.10

%files extras-libclangtidyllvmmodule
%defattr(-,root,root,-)
/usr/lib64/libclangTidyLLVMModule.so.10

%files extras-libclangtidymiscmodule
%defattr(-,root,root,-)
/usr/lib64/libclangTidyMiscModule.so.10

%files extras-libclangtidymodernizemodule
%defattr(-,root,root,-)
/usr/lib64/libclangTidyModernizeModule.so.10

%files extras-libclangtidympimodule
%defattr(-,root,root,-)
/usr/lib64/libclangTidyMPIModule.so.10

%files extras-libclangtidyobjcmodule
%defattr(-,root,root,-)
/usr/lib64/libclangTidyObjCModule.so.10

%files extras-libclangtidyopenmpmodule
%defattr(-,root,root,-)
/usr/lib64/libclangTidyOpenMPModule.so.10

%files extras-libclangtidyperformancemodule
%defattr(-,root,root,-)
/usr/lib64/libclangTidyPerformanceModule.so.10

%files extras-libclangtidyplugin
%defattr(-,root,root,-)
/usr/lib64/libclangTidyPlugin.so.10

%files extras-libclangtidyportabilitymodule
%defattr(-,root,root,-)
/usr/lib64/libclangTidyPortabilityModule.so.10

%files extras-libclangtidyreadabilitymodule
%defattr(-,root,root,-)
/usr/lib64/libclangTidyReadabilityModule.so.10

%files extras-libclangtidyutils
%defattr(-,root,root,-)
/usr/lib64/libclangTidyUtils.so.10

%files extras-libclangtidyzirconmodule
%defattr(-,root,root,-)
/usr/lib64/libclangTidyZirconModule.so.10

%files extras-libclangtooling
%defattr(-,root,root,-)
/usr/lib64/libclangTooling.so.10

%files extras-libclangtoolingastdiff
%defattr(-,root,root,-)
/usr/lib64/libclangToolingASTDiff.so.10

%files extras-libclangtoolingcore
%defattr(-,root,root,-)
/usr/lib64/libclangToolingCore.so.10

%files extras-libclangtoolinginclusions
%defattr(-,root,root,-)
/usr/lib64/libclangToolingInclusions.so.10

%files extras-libclangtoolingrefactoring
%defattr(-,root,root,-)
/usr/lib64/libclangToolingRefactoring.so.10

%files extras-libclangtoolingsyntax
%defattr(-,root,root,-)
/usr/lib64/libclangToolingSyntax.so.10

%files extras-libclangtransformer
%defattr(-,root,root,-)
/usr/lib64/libclangTransformer.so.10
...
%files lib
%defattr(-,root,root,-)
/usr/lib64/clang/10.0.0/lib/linux/libclang_rt.asan-i386.so
/usr/lib64/clang/10.0.0/lib/linux/libclang_rt.scudo-i386.so
/usr/lib64/clang/10.0.0/lib/linux/libclang_rt.scudo_minimal-i386.so
/usr/lib64/clang/10.0.0/lib/linux/libclang_rt.ubsan_minimal-i386.so
/usr/lib64/clang/10.0.0/lib/linux/libclang_rt.ubsan_standalone-i386.so
/usr/lib64/libLTO.so.10
/usr/lib64/libRemarks.so.10
/usr/lib64/libfindAllSymbols.so.10

%files lib32
%defattr(-,root,root,-)
/usr/lib32/libLLVM.so.10
/usr/lib32/libLLVMTableGen.so.10
/usr/lib32/libLTO.so.10
/usr/lib32/libRemarks.so.10
